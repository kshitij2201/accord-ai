...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[9999] p-4">
    <div className="bg-white/10 backdrop-blur-lg rounded-2xl max-w-md w-full relative overflow-y-hidden shadow-2xl">

        {/* Gradient Header */}
        <div className="bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 p-6 text-white relative">
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          ...
          {!isForgotPassword && (
            <>
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 text-black font-medium py-3 px-4 rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:transform-none mb-4 shadow-lg flex items-center justify-center gap-3"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {isSignUp && !isForgotPassword && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border-2 border-cyan-200 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all bg-gradient-to-r from-cyan-50 to-blue-50 text-black"
                  required
                />
              </div>
            )}
            ...
            className="w-full pl-10 pr-4 py-3 border-2 border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-gradient-to-r from-blue-50 to-purple-50 text-black"
            required
            />
...
<input
  ...
  className="w-full pl-10 pr-12 py-3 border-2 border-green-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all bg-gradient-to-r from-green-50 to-blue-50 text-black"
  required
/>
                <button
                  type="button"
